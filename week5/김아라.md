...
### 2.1 렉스타임
렉스타임의 렉스(렉싱)은 컴파일레이션의 첫 단계를 뜻합니다.  
...
#### 3.2.1 충돌 회피
변수와 함수를 스코프 안에 '숨기는 것'의 장점은 같은 이름의 확진자가 충돌하는 것을 피할 수 있다는 점이다.
...
확인자를 글로벌 스코프에 추가할 필요 없이, 특정 스코프로부터 의존성 관리자를 이용하 다양한 명시적인 방법으로 확인자를 가져와 사용할 수 있다.
